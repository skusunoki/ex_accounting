defmodule ExAccounting.Configuration.AccountingAreaTest do
  ...
  test "accounting_area_from_accounting_unit" do
    ...
    _changeset =
      accounting_areas
      |> tap(
        &Enum.map(&1, fn x -> ExAccounting.Configuration.AccountingArea.add_accounting_area(x) end)
      )

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9901", %{
      accounting_unit: "9000",
      accounting_unit_currency: "EUR"
    })

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9901", %{
      accounting_unit: "9001",
      accounting_unit_currency: "EUR"
    })

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9901", %{
      accounting_unit: "9002",
      accounting_unit_currency: "EUR"
    })

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9902", %{
      accounting_unit: "9020",
      accounting_unit_currency: "EUR"
    })

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9902", %{
      accounting_unit: "9021",
      accounting_unit_currency: "EUR"
    })

    ExAccounting.Configuration.AccountingArea.add_accounting_unit("9902", %{
      accounting_unit: "9022",
      accounting_unit_currency: "EUR"
    })

    assert ExAccounting.Configuration.AccountingArea.accounting_area_from_accounting_unit("9000") ==
             %ExAccounting.Elem.AccountingArea{accounting_area: ~c"9901"}

    assert ExAccounting.Configuration.AccountingArea.accounting_area_from_accounting_unit("9020") ==
             %ExAccounting.Elem.AccountingArea{accounting_area: ~c"9902"}
  end

  test "accounting_area_from_accounting_unit by server" do
  end
end
