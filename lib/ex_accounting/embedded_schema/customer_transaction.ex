defmodule ExAccounting.EmbeddedSchema.CustomerTransaction do
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    field(:customer, ExAccounting.Elem.Customer)
    field(:customer_transaction_type, ExAccounting.Elem.CustomerTransactionType)
