defmodule AccountingDocumentItem do
  defstruct fiscal_year: nil,
            accounting_area: nil,
            accounting_document: nil,
            accounting_unit: nil,
            accounting_docuemnt_item: nil,
            debit_credit: nil
end

defmodule AccountingDocumentHeader do
  @moduledoc """
  TODO
  """
  @type t :: %__MODULE__{
